...
import { getAIDoctorSuggestion } from "@/service/patient/ai/ai.service";
import { AISuggestedDoctor } from "@/types/patient/consultation/consultation.interface";
    ...
    <Card className="bg-white shadow-sm rounded-3xl">
      <CardHeader>
        <div className="flex items-center gap-2">
          <div className="p-2 bg-[#473bd1] rounded-lg">
      ...
      <CardContent className="space-y-4">
        ...
        <Button
          ...
          className="cursor-pointer w-full shadow-md hover:bg-[#271f82] bg-linear-to-r from-[#5446ea] to-[#5876f2f1] "
          size="lg"
        >
          {isLoading ? (
            <>
