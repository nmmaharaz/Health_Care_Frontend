...
import { createDoctorSchedule } from "@/service/doctor/doctorSchedule.service";
...
//   console.log("Available Schedules in BookScheduleDialogdgfdgdf:", availableSchedulesState);
  ...
  const loadAvailableSchedules = async () => {
    try {
      ...
      setAvailableSchedules(availableSchedulesState);
  ...
  const groupSchedulesByDate = () => {
    ...
    if (availableSchedulesState.length > 0) {
      availableSchedulesState.forEach((schedule) => {
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="py-4">
          ...
          ) : availableSchedulesState.length === 0 ? (
            <div className="text-center py-8">
