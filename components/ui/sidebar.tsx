  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 shadow-md hidden h-svh transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
...
//       {...props}
//     >
//       {open ? <X className="h-5 w-5" /> : <PanelLeftIcon className="h-5 w-5" />}
