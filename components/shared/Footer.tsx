...
const Footer = () => {
  return (
    <footer className="bg-[#0B1030] mx-7.5 text-white pt-20 my-10 pb-10 px-6 rounded-[50px]">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-6">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-gray-300 text-lg leading-relaxed max-w-70">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-4 group">
                ...
                <span className="text-gray-300">info@domain.com</span>
              </div>
              ...
              <div className="flex items-center gap-4 group">
                ...
                <span className="text-gray-300">+1 (213) 465 789</span>
              </div>
              ...
              <div className="flex items-center gap-4 group">
                ...
                <span className="text-gray-300">2464 Royal Ln. Mesa, New Jersey</span>
              </div>
            </div>
          </div>
        </div>
