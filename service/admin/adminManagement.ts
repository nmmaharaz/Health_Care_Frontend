...
import { createAdminZodSchema, updateAdminZodSchema } from "@/validation/zod/admin/admin.validation";
...
export async function createAdmin(_prevState: any, formData: FormData) {
    ...
    const validatedPayload = zodValidate(validationPayload, createAdminZodSchema);
